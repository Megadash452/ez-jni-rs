...
public final class Native {
    ...
    private void test_native_fns() {
        ...
        Boolean   z_o = native_test_bool_obj(Boolean.valueOf(true));
        Character c_o = native_test_char_obj(Character.valueOf('a'));
        Byte      b_o = native_test_byte_obj(Byte.valueOf((byte)3));
        Short     s_o = native_test_short_obj(Short.valueOf((short)3));
        Integer   i_o = native_test_int_obj(Integer.valueOf(3));
        Long      j_o = native_test_long_obj(Long.valueOf(3L));
        Float     f_o = native_test_float_obj(Float.valueOf(3.3f));
        Double    d_o = native_test_double_obj(Double.valueOf(3.3));
        assert z_o.equals(Boolean.valueOf(true));
        assert c_o.equals(Character.valueOf('a'));
        assert b_o.equals(Byte.valueOf((byte)3));
        assert s_o.equals(Short.valueOf((short)3));
        assert i_o.equals(Integer.valueOf(3));
        assert j_o.equals(Long.valueOf(3L));
        assert f_o.equals(Float.valueOf(3.3f));
        assert d_o.equals(Double.valueOf(3.3));
        ...
        Boolean[]   z_o_a = native_test_bool_obj_array(new Boolean[] {Boolean.valueOf(true), null});
        Character[] c_o_a = native_test_char_obj_array(new Character[] {Character.valueOf('a'), null});
        Byte[]      b_o_a = native_test_byte_obj_array(new Byte[] {Byte.valueOf((byte)1), null});
        Short[]     s_o_a = native_test_short_obj_array(new Short[] {Short.valueOf((short)1), null});
        Integer[]   i_o_a = native_test_int_obj_array(new Integer[] {Integer.valueOf(1), null});
        Long[]      j_o_a = native_test_long_obj_array(new Long[] {Long.valueOf(1L), null});
        Float[]     f_o_a = native_test_float_obj_array(new Float[] {Float.valueOf(1.1f), null});
        Double[]    d_o_a = native_test_double_obj_array(new Double[] {Double.valueOf(1.1), null});
        assert Arrays.equals(z_o_a, new Boolean[] {Boolean.valueOf(true), null});
        assert Arrays.equals(c_o_a, new Character[] {Character.valueOf('a'), null});
        assert Arrays.equals(b_o_a, new Byte[] {Byte.valueOf((byte)1), null});
        assert Arrays.equals(s_o_a, new Short[] {Short.valueOf((short)1), null});
        assert Arrays.equals(i_o_a, new Integer[] {Integer.valueOf(1), null});
        assert Arrays.equals(j_o_a, new Long[] {Long.valueOf(1L), null});
        assert Arrays.equals(f_o_a, new Float[] {Float.valueOf(1.1f), null});
        assert Arrays.equals(d_o_a, new Double[] {Double.valueOf(1.1), null});
